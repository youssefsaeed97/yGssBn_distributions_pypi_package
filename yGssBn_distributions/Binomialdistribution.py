...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        self.p = len([True for x in self.data if x == 1]) / self.n
        self.calculate_mean()
    ...
    def pdf(self, k):
        ...
        return (math.factorial(self.n) * math.pow(self.p, k) * math.pow(1-self.p, self.n-k)) / (math.factorial(k)*math.factorial(self.n-k))
